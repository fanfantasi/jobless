...
class _SchedulePageState extends State<SchedulePage> {
  ...
  void initState() {
    params =
        '&status[equals]=interview&interviewdate[contains]=${DateFormat('yyyy-MM-dd').format(_calendarControllerToday.value)}';
    ...
    _calendarControllerToday.addListener(() {
      ...
      params = '&status[equals]=interview&interviewdate[contains]=$date';
  ...
  void getApplicantsByMyVacancy() async {
    ...
    context
        .read<ScheduleCubit>()
        .getCalendar('?interviewdate[contains]=$dragCalendar');
              ...
              child: BlocBuilder<ScheduleCubit, ScheduleState>(
                builder: (context, state) {
                  if (state is ScheduleLoaded) {
                    eventsAppliants.clear();
                    for (var e in state.schedule.interview) {
                      ...
                      onHorizontalDrag: (p0) {
                        if (dragCalendar != DateFormat('yyyy-MM').format(p0)) {
                          ...
                          Future.delayed(const Duration(milliseconds: 600), () {
                            context.read<ScheduleCubit>().getCalendar(
                                '?interviewdate[contains]=$dragCalendar');
                          });
                        }
                      },
                      innerDot: true,
                    ...
                    child: Padding(
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            Lottie.asset('assets/lottie/schedule.json',
