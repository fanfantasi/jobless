...
class ProfileEmployersPage extends StatefulWidget {
  const ProfileEmployersPage({super.key});

  @override
  State<ProfileEmployersPage> createState() => _ProfileEmployersPageState();
}

class _ProfileEmployersPageState extends State<ProfileEmployersPage> {
  File? photoProfile;
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              BlocBuilder<UserCubit, UserState>(builder: (builder, state) {
                return Column(
                  children: [
                    Container(
                      height: 92,
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: isLoadingPhoto
                                          ...
                                          : CachedNetworkImage(
                                              fit: BoxFit.cover,
                                              imageUrl:
                                                  "${Config.baseUrl}/${Config.imageEmployers}/${state.user!.employersProfile!.photo ?? ''}",
                          ...
                          Column(
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: AutoSizeText(
                                  state.user!.employersProfile!.companyname ??
                                      '',
                                  maxLines: 1,
              ...
              ListCustom(
                ...
                onTap: () async {
                  final res = await Navigator.pushNamed(
                      context, '/profile-form-employers');
                  if (res != null && res is bool) {
                    if (!mounted) return;
                    context.read<UserCubit>().initialUser();
                  }
              ...
              if (context.read<UserCubit>().user!.administrator!)
                administrator(),
              ListCustom(
